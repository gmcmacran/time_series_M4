...
import numpy as np
import pandas as pd
from datasetsforecast.exploration import exploration
...
def prep_data(dataset):
    ...
    if dataset == "hourly":
        train_file = os.path.join("S:\Python\projects\exploration\data", "hourly-train.csv")
        test_file = os.path.join("S:\Python\projects\exploration\data", "hourly-test.csv")
    elif dataset == "daily":
        train_file = os.path.join("S:\Python\projects\exploration\data", "daily-train.csv")
        test_file = os.path.join("S:\Python\projects\exploration\data", "daily-test.csv")
    elif dataset == "weekly":
        train_file = os.path.join("S:\Python\projects\exploration\data", "weekly-train.csv")
        test_file = os.path.join("S:\Python\projects\exploration\data", "weekly-test.csv")
    elif dataset == "monthly":
        train_file = os.path.join("S:\Python\projects\exploration\data", "monthly-train.csv")
        test_file = os.path.join("S:\Python\projects\exploration\data", "monthly-test.csv")
    elif dataset == "quarterly":
        train_file = os.path.join("S:\Python\projects\exploration\data", "quarterly-train.csv")
        test_file = os.path.join("S:\Python\projects\exploration\data", "quarterly-test.csv")
    elif dataset == "yearly":
        train_file = os.path.join("S:\Python\projects\exploration\data", "yearly-train.csv")
        test_file = os.path.join("S:\Python\projects\exploration\data", "yearly-test.csv")
